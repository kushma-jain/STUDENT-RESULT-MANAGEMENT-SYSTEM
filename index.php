...
<html lang="en">
    <head>
        <title>Marks Sheet Management System</title>
            ...
            <div class="navbar navbar-default navbar-static-top" role="navigation">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="Marks/index.php">Admin Login</a></li>
                        <li><a href="Marks/teacherlogin.php">Teacher Login</a></li>
                        <li><a href="Marks/studentlogin.php">Student Login</a></li>
                        <li><a href="Marks/studentregister.php">Student Register</a></li>
                        <li><a href="Marks/teacherregister.php">Teacher Register</a></li>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="divider-wrapper divider-one">
                            ...
                            <h2><a href="Marks/index.php"> Admin </a></h2>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="divider-wrapper divider-two">
                            ...
                            <h2><a href="Marks/teacherlogin.php"> Teacher </a></h2>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="divider-wrapper divider-three">
                            ...
                            <h2><a href="Marks/studentlogin.php"> Student </a></h2>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet.</p>
                        </div>
                    </div>
                </div>
